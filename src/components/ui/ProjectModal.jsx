    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative max-w-2xl w-full bg-panel border border-subtle p-8 overflow-y-auto max-h-[90vh] shadow-2xl"
        >
          <button
            onClick={onClose}
            className="absolute top-4 right-4 text-muted hover:text-electric transition-colors"
